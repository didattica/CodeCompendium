...
> [!IMPORTANT]
> Un protocollo **non è hardware**. È una convenzione logica, implementata in software o firmware. I protocolli esistono a **quasi tutti i layer** del modello OSI, non solo a livello applicativo.
