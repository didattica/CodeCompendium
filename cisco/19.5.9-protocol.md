...
> [!IMPORTANT]
> Un protocollo **non è hardware**. È una convenzione logica, implementata in software o firmware. I protocolli esistono a tutti i layer del modello OSI. Al Layer 1 si parla più propriamente di standard fisici o specifiche, ma anche questi rientrano nella categoria generale di "regole formalizzate per la comunicazione".
